...
def create_app(*, repository, turn_service, comparison_service=None, lifespan=None,
    ...
    app.include_router(build_router(repository, turn_service, comparison_service))
    return app
