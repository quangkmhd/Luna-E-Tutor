...
// Voice & Talk: dùng network_mode: host → phải truy cập qua Docker gateway
const VOICE_HOST = process.env.VOICE_HOST || process.env.VPS_HOST || 'http://127.0.0.1';
const VOICE_PORT = process.env.VOICE_PORT || '7860';
const TALK_HOST = process.env.TALK_HOST || process.env.VPS_HOST || 'http://127.0.0.1';
